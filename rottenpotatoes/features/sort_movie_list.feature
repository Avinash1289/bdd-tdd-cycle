...
Scenario: sort movies alphabetically
  ...
  And I should see "Chocolat" before "Raiders of the Lost Arc"
  And I should see "Raiders of the Lost Arc" before "The Help"
...
Scenario: sort movies in increasing order of release date
  ...
  # your steps here
  Then I should see "2001: A Space Odyssey" before "Raiders of the Lost Arc"
  And I should see "Raiders of the Lost Arc" before "The Terminator"
  And I should see "The Terminator" before "When Harry Met Sally"
